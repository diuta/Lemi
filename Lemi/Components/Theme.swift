...
extension Font {
    struct AppTheme {
        ...
        static let screenTitle = Font.system(size: 32, weight: .bold, design: .default)
        ...
        static let pillText = Font.system(size: 14, weight: .medium, design: .default)
        
        /// Used for the main action button ("Generate")
        static let buttonText = Font.system(size: 18, weight: .bold, design: .default)
    }
}
